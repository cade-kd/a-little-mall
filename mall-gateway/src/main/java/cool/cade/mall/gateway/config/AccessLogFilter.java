package cool.cade.mall.gateway.config;
...
//    private AccessLogService accessLogService;
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        String remoteIpAddress = request.getRemoteAddress().toString();
        String localIpAddress = request.getLocalAddress().toString();
        ...
        gatewayLog.setLocalIp(localIpAddress);
        gatewayLog.setRemoteIp(remoteIpAddress);
